          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite seu nome"  style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;">
            ...
            <div class="col-md-6">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="sobrenome" name="sobrenome" placeholder="Digite seu sobrenome"  style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;">
            ...
            <div class="col-md-6">
              ...
              <div class="form-floating mb-3">
                <input type="email" class="form-control" id="email" name="email" placeholder="nome@exemplo.com"  style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;">
            ...
            <div class="col-md-6">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="senha" name="senha" placeholder="Senha"  style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;">
            ...
            <div class="col-md-6">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="escola" name="escola" placeholder="Nome da escola"  style="border-style: solid; border-color: #000000; border-width: 2px; border-radius: 26px;">
