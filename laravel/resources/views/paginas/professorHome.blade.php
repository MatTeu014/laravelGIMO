        ...
        <div class="container" style="margin: auto;">
            <div class="row align-items-center">
                ...
                <form action="professorturmas" method="get">
                    <div class="card" style="width: 20rem; height: 35vh; border-color: white;">
                        <div class="card-body">
                            <button name="turma" type="submit" value="Turma 1" style="font-size: 50px; border-radius: 30px; border-color:rgb(245, 101, 58); border-style: solid; background-color: white;">Turma 1</button>
                        </div>
                    </div>
                
                    <div class="card" style="width: 20rem; height: 35vh; border-color: white;">
                        <div class="card-body">
                            <button name="turma" value="Turma 2" style="font-size: 50px; border-radius: 30px; border-color: rgb(245, 101, 58); border-style: solid; background-color: white;">Turma 2</button>
                        </div>
                    </div>

                    <div class="card" style="width: 20rem; height: 35vh; border-color: white;">
                        <div class="card-body">
                            <button name="turma" value="Turma 3" style="font-size: 50px; border-radius: 30px; border-color: rgb(245, 101, 58); border-style: solid; background-color: white;">Turma 3</button>
                        </div>
                    </div>

                    <div class="card" style="width: 20rem; height: 35vh; border-color: white;">
                        <div class="card-body">
                            <button name="turma" value="Turma 4" style="font-size: 50px; border-radius: 30px; border-color: rgb(245, 101, 58); border-style: solid; background-color: white;">Turma 4</button>
                        </div>
                    </div>
                </form>
